        ...
        <div class="container">
            ...
            ?>
                    ...
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Il semble que vous ne disposez d'aucun accès.</h6>
                    </div>
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Veuillez contacter votre administrateur <b><?php echo $info_admin['sexe_cl'].' '.$info_admin['prenom_cl'].' '.$info_admin['nom_cl']; ?></b> afin qu'il puisse vous donner accès dans ses entreprises.</h6>
                    </div>
                    <!--<div class="alert alert-success" role="alert">
