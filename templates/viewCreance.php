    ...
    <style type="text/css">
      ...
      #adresstr
      {
        height: 126px;
         ...
         <title>KEDIS Online! | Mes dépenses | Détails créance</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
    <!--Début body-->
        ...
        <!--Code PHP-->
                 <?php 
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['id_cre']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $id_cre = $_GET['id_cre'];
                          $reqvente = $bdd->prepare("SELECT * FROM creance_for_user WHERE id_cre = ?"); 
                          $reqvente->execute(array($id_cre));
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="creance.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>">Mes créances</a></li>
                                        <li class="active">Détails créance</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-block" id="delete_creance">
                          <span class="step size-21">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      ...
                      <div class="bs-callout bs-callout-warning">
                        <div class="row">
                          <div class="col-md-8">
                            ...
                            <h6>Voulez-vous vraiment supprimer cette créance ?</h6>
                          </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="delete_creance" id="delete_creance">Oui</button>
              ...
              <div class="modal fade" id="solder-creance" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                      <button type="button" class="btn btn-primary" id="solder_creance">Solder</button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header badge-secondary text-white">
                        <div class="row">
                          <div class="col-md-10">
                            <h6 class="modal-title" id="exampleModalLabel">Echéance créance <label class="text-secondary" id="id_echeance">0</label></h6>
                          </div>
                          <div class="col-md-2">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              function affiche_detail()
              {
                ...
                var id_cre = '<?php echo $id_cre; ?>';
                var devise = '<?php echo $devise; ?>';

                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/detail_creance.php',
                  data : 'id_cre=' + id_cre + '&devise=' + devise,
              ...
              function affiche_transaction()
              {
                ...
                $.ajax(
                  {
                    type  : 'POST', 
                    url   : 'fonction/affiche_transaction_creance.php',
                    data  : 'id_cre=' + id_cre + '&idUE=' + idUE + '&devise=' + devise,
                    success:function(data)
                    {
             ...
             $('#change_echeance').click(function()
              {
                ...
                {
                  type  : 'POST',
                  url   : 'fonction/new_echeance_creance.php',
                  data  : 'id_cre=' + id_cre + '&date_echeance=' + date_echeance,
                  success:function(data)
                  {
              ...
              function apercu()
              {
                ...
                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/apercu_creance.php',
                  data : 'id_cre=' + id_cre + '&devise=' + devise,
                  success:function(data)
                  {
            ...
            $('#delete_creance').click(function()
                {
                  ...
                  swal({
                          title: "Confirmer !",
                          text: "Voulez-vous vraiment supprimer cette créance ?",
                          type: "warning",
                          ...
                          function(){
                              ...
                              swal(
                                {
                                  title: "Supprimé !!",
                                text: "La créance a été supprimé avec succès !!",
                                type: "success",
                                confirmButtonColor: "#28a745",
                                }, function(){ window.location = 'creance.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE; });
                          });
                });


              function delete_creance()
              {
                  var id_cre = '<?php echo $id_cre; ?>';
                  ...
                  {
                    type  : 'POST', 
                    url   : 'fonction/deleteCreance.php',
                    data  : 'id_cre=' + id_cre, 
                    success:function()
                    {
                                        ...
                                        if(donnee == 1)
                                        {
                                          ...
                                          else
                                          {
                                            $.ajax(
                                              {
                                                type  : 'POST', 
                                                url   : 'fonction/solder_creance.php',
                                                data  : 'id_cre=' + id_cre + '&montant=' + montant +
                                                ...
                                                success:function(data)
                                                {
                                                  ...
                                                  $('#num_cmp').val('');
                                                  valid3('Créance effectuée avec succès');
