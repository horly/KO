    ...
    <style type="text/css">
      ...
      .viewtva_ser
      {
       ...
       #libsearchcatart5, #libsearchcatart6 {
         ...
         <title>KEDIS Online! | Mes catégories d'articles</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Mes catégories d'articles</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                  <h6 class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                      ...
                      ?>
                        <li class="nav-item">
                          <a class="nav-link active" href="#"><strong>Mes catégories d’articles</strong></a>
                        </li>
                      <?php
                          }
                      ?>
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des catégories d'articles</b></strong></div>
                                <div class="card-body">
                                  ...
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                        ...
                                        $view = $bdd->prepare("SELECT * FROM categorie_article WHERE id_UE_art = ? AND default_cat_art != ?");
                                        ...
                                        $i = 1;
                                         ...
                                         ?>   
                                            <tr>
                                              <td><?php echo $i++; ?></td>
                                              <td class="text-left"><?php echo $row['libelle_cat_art']; ?></td>
                                              <td class="text-center">
                                                <?php
                                                    $nbrart = $bdd->prepare("SELECT * FROM article_for_user WHERE id_CAT = ?"); 
                                                    $nbrart->execute(array($row['id_cat_art']));
                                              ...
                                              <td>
                                                <a class="text-primary" href="viewCatArticle.php?id=<?php echo $getid;?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE;?>&nom_entreprise=<?php echo $nomE;?>&nom_unite_exploitation=<?php echo $nomUE;?>&idcatart=<?php echo $row['id_cat_art'];?>">Détails</a>
                                              </td>
                                            </tr>
                                          <?php 
                                            } 
