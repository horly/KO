                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idClient']) AND isset($_GET['refcaise']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $idTable = $fetchIdVente['id_table'];

                          //si vente est vraiment sélectionné dans une table 
                          
                            //on sélectionne aussi la table 
                            $viewTables = $bdd->prepare("SELECT * FROM tables WHERE id = ?");
                            $viewTables->execute(array($idTable));
                            $info_table = $viewTables->fetch();

                            $designation_table = $info_table['designation'];
                            $id_serveur = $info_table['id_serveur'];

                            //on sélectionne le serveur
                            $get_serv = $bdd->prepare("SELECT * FROM serveur WHERE id_serv = ?");
                            $get_serv->execute(array($id_serveur));
                            $info_serv = $get_serv->fetch();

                            $prenom_serv = $info_serv['prenom_serv'];
                            $nom_serv = $info_serv['nom_serv'];
          ...
          <nav class="navbar navbar-expand-sm navbar-default">
              <div id="main-menu" class="main-menu collapse navbar-collapse">
                  <ul class="nav navbar-nav">
                      ...
                      <li>
                          <a class="select-table" href="#" id=""><i class="menu-icon fa fa-repeat"></i>Nouvelle vente </a>
                      </li>
                      <li>
                      ...
                      <table class="bootstrap-data-table table table-striped table-bordered">
                        ...
                        <tbody class="tbody_striped" id="table_pause_vente">
                          <?php
                              ...
                              $view = $bdd->prepare("SELECT * FROM vente_for_user WHERE id_UE_fact = ? AND caisse_vente = ? AND reprise_vente = ? AND complete_vente = ? AND id_table != ? ORDER BY reference_caise DESC");
        ...
        <div id="right-panel" class="right-panel">
            ...
            <!--debut modale new article-->
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                      <div class="modal-header text-white bg-secondary">
                        <div class="row">
                          <div class="col-md-10">
                            <h6 class="modal-title" id="myModalLabel">Enregistrer une table</h6>
                          </div>
                          <div class="col-md-2">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                      ...
                      <div class="modal-body" id="body-categorie">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="Entrer la désignation de la table" aria-label="Recipient's username" aria-describedby="basic-addon2" name="design_table" id="design_table" required="">
                        </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <select class="custom-select" id="serveur">
                            <option selected="" value="">Choisir un(e) serveur(se)</option>
                            <?php
                      ...
                      <div class="modal-body body-modal-client">
                        ...
                        <div class="card form_card">
                          <div class="card-body">
                               ...
                               <div class="row">
                                <div class="col-md-6">
                                  <label for="civilite_serv"><h6>Civilié</h6></label>
                                  <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"><img width="18" height="18" class="icone" src="../png/512/genre.png"></span>
                                    </div>
                                    <select class="custom-select" name="civilite_serv" id="civilite_serv">
                                        <option selected value="Monsieur">Monsieur</option>
                                        <option value="Madame">Madame</option>
                                    </select>
                                  </div>
              ...
              <!--fin modale new fin-->
                ...
                <!-- Modal addition -->
              <div class="modal fade" id="print_addition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLongTitle">Imprimer l'addition</h6>
                        </div>
                        <div class="col-md-2">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body ticket-body" id="addition_detail">
                     
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                      <button type="button" class="btn btn-primary" id="print-addition-vente">Imprimer</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Modal addition -->
              <div class="modal fade" id="print_commande" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLongTitle">Imprimer commande</h6>
                        </div>
                        <div class="col-md-2">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body ticket-body" id="commande_detail">
                     
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                      <button type="button" class="btn btn-primary" id="print-commande-vente">Imprimer</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="modal fade bd-example-modal-lg" id="view-table" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLabel">Recherche table</h6>
                        </div>
                        <div class="col-md-2">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                      <div class="p-3 mb-2 bg-light text-dark border">
                        <button type="button" class="btn btn-success" id="new_table">
                            <span class="step size-21">
                      ...
                      <div class="p-3 mb-2 bg-light text-dark border">
                        ...
                        <?php
                          ...
                          $viewTable = $bdd->prepare("SELECT * FROM tables WHERE idUE_table = ?");
                          $viewTable->execute(array($idUE));
                          $existallcatTable = $viewTable->rowCount();

                          if(preg_match("/^[1-9]+/", $existallcatTable))
                          {
                        ?>
                          <div class="row">
                        <?php
                            while($row = $viewTable->fetch())
                            {
                        ?>

                          <div class="col-md-3">
                            <button class="btn btn-secondary btn-block button-table" id="<?php echo $row['id']; ?>">
                              <?php echo $row['designation']." (".$row['reference'].")"; ?>
                            </button>
                          </div>
                          <br><br>
                        ...
                        ?>
                          <div class="alert alert-primary text-center" role="alert">
                                Vous ne disposez d'aucune table.                   
                          </div>
                        <?php
                          }
                        ?>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" readonly="" id="table-affiche" value="<?php echo $designation_table; ?>">
                              <div class="input-group-append">
                                <button class="btn btn-outline-primary select-table" type="button" id="">
                                  <span class="step size-21">
                          ...
                          <div class="col-md-6">
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                ...
                                <!--<span class="input-group-text" id="basic-addon1">Serveur(se)</span>-->
                              </div>
                              <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" readonly="" value="<?php echo $prenom_serv.' '.$nom_serv; ?>">
                            </div>
                          </div>  
                        </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="input-group mb-3">
                              <button type="button" class="btn btn-outline-primary btn-block" id="addition">
                                  <span class="step size-21">
                          ...
                          <div class="col-md-6">
                            <div class="input-group mb-3">
                              <button type="button" class="btn btn-outline-primary btn-block" id="commande_caisse">
                                  <span class="step size-21">
       ...
       <?php  include('chat_discution.php'); ?>
        ...
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            $('.button-table').click(function()
              {
                ...
                window.location = 'vente_init_caisse_restaurant_second.php?id=' + getid + '&id_connexion=' + id_connexion + '&idUE=' + idUE + '&nom_entreprise=' + nomE + '&nom_unite_exploitation=' + nomUE + '&id_table=' + id_table;
                
              });


            //pour imprimer les additions 
                ...
                $.ajax(
                  {
                    ...
                    success:function(data)
                    {
                      ...
                      if(data != 1)
                      {
                        err3("Veuillez au moins insérer un article pour imprimer la l'addition !");
                      }
                      else
                      {
                        affiche_addition();
                        $('#print_addition').modal('show');
                      }
                    }
                  });
              });
            ...
            $('#commande_caisse').click(function()
              {
                var idvente = '<?php echo $idvente; ?>';
                ...
                $.ajax(
                  {
                    ...
                    success:function(data)
                    {
                      ...
                      if(data != 1)
                      {
                        err3("Veuillez au moins insérer un article pour imprimer la commande !");
                      }
                      else
                      {
                        affiche_commande();
                        $('#print_commande').modal('show');
                      }
                    }
                  });
              });
            ...
            function affiche_addition()
            {
               var num_vente = '<?php echo $idvente; ?>';
               var idUE = '<?php echo $idUE; ?>';
               var getprenom = '<?php echo $getprenom; ?>';
               var devise = '<?php echo $devise; ?>';
               var designation_table = '<?php echo $designation_table; ?>';
               var prenom_serv = '<?php echo $prenom_serv; ?>';;
               var nom_serv = '<?php echo $nom_serv; ?>';

               $.ajax(
                {
                  type  : 'POST', 
                  url   : 'fonction/affiche_addition.php',
                  data  : 'num_vente=' + num_vente + '&idUE=' + idUE + '&getprenom=' + getprenom + '&devise=' + devise + 
                          '&designation_table=' + designation_table + '&prenom_serv=' + prenom_serv + '&nom_serv=' + nom_serv,
                  success:function(data)
                  {
                    $('#addition_detail').html(data);
                  }
                });
            }
             ...
             function affiche_commande()
            {
               ...
               $.ajax(
                {
                  type  : 'POST', 
                  url   : 'fonction/affiche_commande_caisse.php',
                  data  : 'num_vente=' + num_vente + '&idUE=' + idUE + '&getprenom=' + getprenom + '&devise=' + devise + 
                          '&designation_table=' + designation_table + '&prenom_serv=' + prenom_serv + '&nom_serv=' + nom_serv,
                  success:function(data)
                  {
                    $('#commande_detail').html(data);
                  }
                });
            }
             ...
             //imprimer addition
           $('#print-addition-vente').click(function()
              {
                var idvente = '<?php echo $idvente; ?>';
                var idUE = '<?php echo $idUE; ?>';
                var getprenom = '<?php echo $getprenom; ?>';
                ...
                window.open('facture/pdf/ticket_addition.php?idvente=' + idvente + '&idUE=' + idUE + '&getprenom=' + getprenom + '&devise=' + devise + '&designation_table=' + designation_table + '&prenom_serv=' + prenom_serv + '&nom_serv=' + nom_serv, '_blank');
            ...
            //imprimer commande
           $('#print-commande-vente').click(function()
              {
                var idvente = '<?php echo $idvente; ?>';
                var idUE = '<?php echo $idUE; ?>';
                var getprenom = '<?php echo $getprenom; ?>';
                ...
                window.open('facture/pdf/ticket_commande.php?idvente=' + idvente + '&idUE=' + idUE + '&getprenom=' + getprenom + '&devise=' + devise + '&designation_table=' + designation_table + '&prenom_serv=' + prenom_serv + '&nom_serv=' + nom_serv, '_blank');
           ...
           $('#save_table').click(function()
              ...
              if(design_table != '')
              {
                if(serveur != '')
                {
                  $.ajax(
                    {
                      type  : 'POST', 
                      url   : 'fonction/add_new_table.php',
                      data  : 'design_table=' + design_table + '&serveur=' + serveur + '&idUE=' + idUE,
                      success:function(data)
                      {
                        if(data == 1)
                        {
                        ...
                        else
                        {
                          ...
                          $('#design_table').val('');
                          $('#design_table').val('Choisir un(e) serveur(se)');

                          valid3('Nouvelle table enregistrée avec succès');
            ...
            //ajouter un nouveau serveur 
              $('#saveserv').click(function()
                {
                  var civilite = $('#civilite_serv').val();
            ...
            $('#pause_vente').click(function()
              {
                      ...
                      success:function(data)
                      {
                        ...
                        else
                        {
                          $.ajax(
                          {
                            ...
                            {
                              //alert(data1);
                              window.location.href = 'vente_init_caisse_restaurant.php?id=' + getid + '&id_connexion=' + id_connexion + "&idUE=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE;
                            }
                          });
                        }
                      }
                ...
                {
                  err3("Veuillez d'abord sélectionner une table.");
                }
              });
