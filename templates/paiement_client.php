    ...
    .container-tab1 {
      ...
      .form_card
       ...
       #libsearchcatart {
         ...
         <title>KEDIS Online! | Paiement client</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                ...
                <div class="card">
                  <h6 class="card-header">
                     <ul class="nav nav-pills card-header-pills">
                      <li class="nav-item">
                        <a class="nav-link active" href="#"><strong>Factures</strong></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="paiement_client_note_credit.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&id_cmp=<?php echo $id_cmp; ?>"><strong>Notes de crédit</strong></a>
                      </li>
                    </ul>
                  </h6>
                  ...
                  <?php 
                      ...
                      $view = $bdd->prepare("SELECT * FROM vente_for_user WHERE id_UE_fact = ? AND reste_a_payer_fact != 0 AND complete_vente != ?");
                    ...
                    ?>
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des factures de vente à payer (Total : <?php echo $existallvente; ?>)</b></strong></div>
                                <div class="card-body">
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                            ...
                                            $get_fact = $bdd->prepare('SELECT * FROM vente_for_user WHERE id_UE_fact = ? AND reste_a_payer_fact != 0 ORDER BY id_fact DESC');
                                            $get_fact->execute(array($idUE));

                                            $i = 1;

                                            $existallcat = $get_fact->rowCount();

                                        
                                            while($row = $get_fact->fetch()) 
                                            {
                                         ?>   
                                            <tr>
                                              ...
                                              <td class="text-left">
                                                <?php
                                                    ...
                                                    $get_debiteur->execute(array($row['id_cl_fact']));
                                              ...
                                              <td class="text-left">
                                                <?php
                                                    ...
                                                    $get_gestionnaire->execute(array($row['id_gest_fact']));
                                              ...
                                              <td>
                                                <a role="button" class="text-primary viewFacture" href="#" id="<?php echo $row['id_fact']; ?>" option="<?php echo $row['reste_a_payer_fact']; ?>" data-toggle="modal" data-target="#detail-facture">Consulter</a>
                                              </td>
                                            </tr>
                                          <?php 
                                            } 
                                    ?>
                                      ...
                                      <?php
                                        $sum_fact = $bdd->prepare("SELECT SUM(reste_a_payer_fact) AS montant_reste FROM vente_for_user WHERE reste_a_payer_fact != 0 ");
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header badge-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLabel">Détail dette client <label class="text-secondary" id="idachat">0</label> <label class="text-secondary"  id="dette_initial">0</label></h6>
                        </div>
                        <div class="col-md-2">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            function affiche_facture_apayer()
            {
              ...
              $.ajax(
                {
                  type  : 'POST',
                  url   : 'fonction/affiche_facture_apayer_client.php',
            ...
            $('.viewFacture').click(function()
            {
              ...
              {
                type  : 'POST',
                url   : 'fonction/affiche_detail_dette_client.php',
                data  : 'idvente=' + idvente + '&devise=' + devise + '&idUE=' + idUE + '&id_cmp=' + id_cmp,
                success:function(data)
                {
                  $('#idachat').text(idvente);
                                    ...
                                    $.ajax(
                                      {
                                        ...
                                        success:function(data)
                                        {
                                          ...
                                          $('#num_cmp_cli').val('');
                                          valid3('Encaissement effectué avec succès');
