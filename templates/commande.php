    ...
    .container-tab1 {
      ...
      .form_card
       ...
       #libsearchcatart {
         ...
         <title>KEDIS Online! | Mes dépenses | Mes commandes</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                ...
                <div class="card">
                  <h6 class="card-header">
                     <ul class="nav nav-pills card-header-pills">
                      ...
                      ?>
                        <li class="nav-item">
                          <a class="nav-link active" href="#"><strong>Mes commandes</strong></a>
                        </li>
                      <?php
                          }
                      ?>
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des commandes (Total : <?php echo $existallvente; ?>)</b></strong></div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                      <div class="col-md-3">
                                        ...
                                        ?>
                                            ...
                                            <a role="button" class="btn btn-success btn-block" href="commande_init.php?id=<?php echo $getid;?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE;?>&nom_entreprise=<?php echo $nomE;?>&nom_unite_exploitation=<?php echo $nomUE;?>">
                                        ...
                                        ?>
                                          ...
                                          <div class="alert alert-primary" role="alert">
                                            Vous avez atteint le nombre maximal de commandes.
                                          </div>
                                  ...
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                       ...
                                       $view = $bdd->prepare("SELECT * FROM commande WHERE id_UE_cmd = ? AND complete_cmd != ? ORDER BY reference_cmd DESC");
                                        $view->execute(array($idUE, 0));
                                        ...
                                        $existallvente = $view->rowCount();
                                         ...
                                         ?>   
                                           <tr>
                                              <td><a class="text-primary" href="viewCommande.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&id_cmd=<?php echo $row['id_cmd']; ?>"><?php echo $row['num_cmd']; ?></a></td>
                                              <td class="text-left"><?php echo $row['date_cmd']; ?></td>
                                              <td class="text-left">
                                                <?php
                                                    $nbrcli = $bdd->prepare("SELECT * FROM fournis_for_user WHERE id_four = ?"); 
                                                    $nbrcli->execute(array($row['id_four_cmd']));
                                              ...
                                              <td class="text-center">
                                                <?php  
                                                  ...
                                                  $count_art = $bdd->prepare("SELECT * FROM facturation_commande WHERE id_cmd = ?");
                                                  $count_art->execute(array($row['id_cmd']));

                                                  $nbr_art = $count_art->rowCount();
                                              ...
                                              <td class="text-center">
                                                <?php  
                                                    ...
                                                    $quant_total = $bdd->prepare("SELECT SUM(quantite_art_cmd) AS total_quantite FROM facturation_commande WHERE id_cmd = ?");
                                                    $quant_total->execute(array($row['id_cmd']));

                                                    $total_quantite = $quant_total->fetch();

                                                    echo $total_quantite['total_quantite'];
                                                ?>
                                                </td>
                                              <td class="text-left"><?php echo $row['delai_livraison']; ?></td>
                                              <td class="text-left">
                                                <?php 
                                                    $get_user = $bdd->prepare('SELECT * FROM user WHERE id_cl = ?'); 
                                                    $get_user->execute(array($row['id_gest_cmd']));
                                                    $info_user = $get_user->fetch();

                                                    echo $info_user['prenom_cl'];
                                                ?>
                                                </td>
                                              <td>
                                                <a class="text-primary" href="viewCommande.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&id_cmd=<?php echo $row['id_cmd']; ?>">Détails</a>
                                              </td>
                                            </tr>
                                          <?php 
                                            } 
