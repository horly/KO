    ...
    <style type="text/css">
      ...
      .btn-orange:hover
      {
        background-color: #D2691E;
         ...
         <title>KEDIS Online! | Mes dépenses | Détails commande</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['id_cmd']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $reqvente = $bdd->prepare("SELECT * FROM commande WHERE id_cmd = ?"); 
                          $reqvente->execute(array($id_cmd));
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Détails commande</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
              ...
              <div class="animated fadeIn">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-2">
                        <a role="button" class="btn btn-info btn-block" href="commande_finish.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&id_cmd=<?php echo $id_cmd; ?>">
                      ...
                      <div class="col-md-2">
                        <a role="button" class="btn btn-primary btn-block" id="update" href="facturation_commande.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&refcaise=<?php echo $refCaise; ?>&idFour=<?php echo $idFour; ?>">
                          <span class="step size-21">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              function affiche_detail()
              {
                ...
                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/detail_view_commande.php',
                  data : 'id_cmd=' + id_cmd + '&devise=' + devise,
                  ...
                  swal({
                          ...
                          function(){
                              ...
                              swal(
                                ...
                                type: "success",
                                confirmButtonColor: "#28a745",
                                }, function(){ window.location = 'commande.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE; });
                          });
                });
              ...
              function delete_achat()
              {
                  ...
                  {
                    type  : 'POST', 
                    url   : 'fonction/deleteCommande.php',
                    data  : 'id_cmd=' + id_cmd, 
                    success:function()
                    {
                      w
