    ...
    .container-tab1 {
      ...
      #adressfour, #adresstr
      {
        height: 126px;
         ...
         <title>KEDIS Online! | Mes dépenses | Mes créances</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Mes créances</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                  <h6 class="card-header">
                     <ul class="nav nav-pills card-header-pills">
                      ...
                      ?>
                        <li class="nav-item">
                          <a class="nav-link active" href="#"><strong>Mes créances</strong></a>
                        </li>
                       <?php
                          }
                      ?>
                      ...
                      ?>
                        <li class="nav-item">
                          <a class="nav-link" href="dette.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>"><strong>Mes dettes</strong></a>
                        </li>
                      <?php
                          }
                      ?>
                   ...
                   <?php 
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des créances/prêts (Total : <?php echo $existallvente; ?>)</b></strong></div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                      <div class="col-md-3">
                                        ...
                                        ?>
                                           ...
                                           <button type="button" class="btn btn-success btn-block" id="get-creance">
                                            <span class="step size-21">
                                                <i class="icon ion-clipboard"></i>
                                            </span>
                                                &nbsp;Enregistrer une créance</button>
                                        ...
                                        ?>
                                          ...
                                          <div class="alert alert-primary" role="alert">
                                            Vous avez atteint le nombre maximal de créances.
                                          </div>
                                  ...
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                      <tr>
                                        <th>Date</th>
                                        <th>Créancier</th>
                                        <th>Montant créance (<?php echo $devise; ?>)</th>
                                        <th>Echéance</th>
                                        <th>A encaisser (<?php echo $devise; ?>)</th>
                                        <th>Gestionnaire</th>
                                        <th>Remarques</th>
                                        <th></th>
                                      </tr>
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                        ...
                                        $view = $bdd->prepare("SELECT * FROM creance_for_user WHERE id_UE_cre = ? AND default_cre != 1 ORDER BY id_cre DESC");
                                        $view->execute(array($idUE));
                                        $i = 1; 
                                        ...
                                        $existallvente = $view->rowCount();
                                         ...
                                         ?>   
                                           <tr>
                                              <td class="text-left"><?php echo $row['date_cre']; ?></td>
                                              <td class="text-left">
                                                <?php
                                                    $nbrcli = $bdd->prepare("SELECT * FROM autres_tiers WHERE id_tr = ?"); 
                                                    $nbrcli->execute(array($row['id_autre_tier_cre']));
                                              ...
                                              <td class="text-right"><?php echo number_format($row['montant_cre'], 2, '.', ' '); ?></td>
                                              <td class="text-left"><?php echo $row['echeance_cre']; ?></td>
                                              <td class="text-right"><?php echo number_format($row['reste_a_payer'], 2, '.', ' '); ?></td>
                                              <td class="text-left">
                                                <?php 
                                                  $nbrcli = $bdd->prepare("SELECT * FROM user WHERE id_cl = ?"); 
                                                    $nbrcli->execute(array($row['id_gest_cre']));
                                              ...
                                              <td class="text-left"><?php echo $row['remarque_cre']; ?></td>
                                              <td>
                                                <a class="text-primary" href="viewCreance.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&id_cre=<?php echo $row['id_cre']; ?>">Détails</a>
                                              </td>
                                            </tr>
                                          <?php 
                                            } 
                                    ...
                                    <?php
                                        ...
                                        //somme total à payer
                                        $somme_mt_fact = $bdd->prepare("SELECT SUM(montant_cre) AS somme_ttc FROM creance_for_user WHERE id_UE_cre = ? AND default_cre != 1");
                                        ...
                                        //somme reste à payer
                                        $somme_reste = $bdd->prepare("SELECT SUM(reste_a_payer) AS somme_reste FROM creance_for_user WHERE id_UE_cre = ? AND default_cre != 1");
                      ...
                      <div class="modal-body bg-light">
                        ...
                        <div class="p-3 mb-2 form_card text-dark border">   
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <label for="Montpaye"><h6>Montant créance/prêt</h6></label>
                              <div class="input-group mb-3">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="input-group mb-3">
                                <input type="text" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="num_cmp" id="num_cmp" placeholder="Saisir le numéro de compte du créancier">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="p-3 mb-2 bg-secondary text-white border">  
                          <div class="row">
                            <div class="col-md-6">
                              <label for="autre-tiers"><h6>Autre tiers/créancier</h6></label>
                              <div class="input-group mb-3">
       ...
       <?php  include('chat_discution.php'); ?>
        ...
        <script type="text/javascript">
          jQuery(document).ready(function($) 
          {
             ...
             //affiche_creance();
              ...
              function affiche_creance()
              {
                ...
                var id_connexion = '<?php echo $id_connexion; ?>';
                 ...
                 $.ajax({
                  type : 'POST', 
                  url  : 'fonction/affiche_creance.php',
            ...
            //nouveau dépense
            $('#get-creance').click(function()
              {
                $('#new-creance').modal('show');
              });
               ...
               $('#affichage').click(function()
                {
                  ...
                  else
                  {
                    $.ajax({
                      type : 'POST', 
                      url  : 'fonction/affiche_creance_selection.php',
                      data : 'idUE=' + idUE  + '&id_connexion=' + id_connexion +
