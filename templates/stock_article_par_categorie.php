                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <?php
                                  ...
                                  $reqseecat = $bdd->prepare("SELECT * FROM categorie_article WHERE id_cat_art = ? AND id_UE_art = ?");
                              ...
                              <div class="dropdown show">
                                <a class="btn btn-default btn-block dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <?php echo $libcat['libelle_cat_art']; ?>
                                </a>
                                  ...
                                  <table>
                                    ...
                                    <tbody class="tbody_striped">
                                      ...
                                      if(isset($_POST['searchcatart']))
                                      {
                                        ...
                                        {
                                          $view = $bdd->prepare("SELECT * FROM article_for_user WHERE id_CAT = ? AND idUE_art = ?");
                                          ...
                                          else
                                        {
                                          ?>
                                            <div class="alert alert-warning" role="alert">
                                              <h6 class="text-center">
                                                Vous ne disposez d'aucun article de cette catégorie
                                              </h6>
                                            </div>
                                        <?php
                                        }   
