      ...
      /*rendre le tableau le curseur des pointer*/
       ...
       .scrollfact
        ...
        .viewtva_ser
        {
         ...
         <title>KEDIS Online! | Mes dépenses | achat</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Créer un nouvel achat</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                 ...
                                 <div class="card-body">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-2">
                                          <div class="input-group mb-3">
                                            &nbsp;&nbsp;
                                            <button class="btn btn-info" title="Modifier" id="modif_cout">
                                                  <span class="step size-21">
        ...
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            function affiche_designation()
            {
              ...
              $.post('fonction/recup_achat_depense.php', {idachat:idachat}, function(data)
              {
                $('#tbody_fac').html(data);
              });
            }
           ...
           $('.insert-facture').click(function()
              {
                ...
                {
                  type : 'POST',
                        url : 'fonction/select_article_facture_achat_primo.php',
            ...
            $('.insert-facture1').click(function()
              {
                ...
                $.ajax(
                  {
                    type : 'POST',
                      url : 'fonction/select_service_facture_achat_primo.php',
