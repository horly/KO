...
<!--Début html-->
    ...
    #moyenne_entreprise
    {
      display: none;
         ...
         <title>KEDIS Online! Gérer les Unités d'exploitation</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
        ...
        <!--Code PHP-->
               <?php 
                   ...
                   // session_start();
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['id_abonne']) AND isset($_GET['idE']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      $getid = $_GET['id']; 
                      ...
                      $getidEnt = $bdd->prepare("SELECT * FROM entreprise WHERE idE = ?");
                      $getidEnt->execute(array($getidE));

                      $fetchE = $getidEnt->fetch();
    ...
    <div id="body">              
        ...
        <div class="container">
         ...
         <div class="p-3 mb-2 bg-white text-dark">
           <div class="row">
             <div class="col-md-6">
               <h5>Gerer les Unités d'exploitation</h5>
             </div>
             <div class="col-md-6">
               <h5 class="text-right"><a href="unitexpl.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idE=<?php echo $getidE; ?>&nom_entreprise=<?php echo $nomE; ?>">Unités d'exploitation </a>/ Gerer les Unités d'exploitation</h5>
             </div>
           </div>
         </div>
          ...
          <div class="card border-info mb-3" >
            <div class="card-header text-left"><strong><b>Gerer les Unités d'exploitation</b></strong></div>
              <div class="card-body">
                ...
                ?>
                    ...
                    <div class="alert alert-warning" role="alert">
                      Votre abonnement est de type <b><?php echo $type_abonne; ?></b>. Veuillez cocher les Unités d'exploitation que vous voulez utiliser.
                    </div>
                ...
                ?>
                  ...
                  <div class="alert alert-danger" role="alert" id="petite_entreprise">
                      Vous devez cocher une seule Unités d'exploitation car votre abonnement est de type <b><?php echo $type_abonne; ?></b>.
                  </div>

                  <div class="alert alert-danger" role="alert" id="moyenne_entreprise">
                      Vous devez juste cocher 5 les Unités d'exploitation car votre abonnement est de type <b><?php echo $type_abonne; ?></b>.
                  </div>
                ...
                ?>
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center ">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input checkbox" id="<?php echo $row['nomUE']; ?>" <?php if($row['statut'] == 1){ echo 'checked="true"'; }?> statut="<?php echo $row['statut']; ?>" option="<?php echo $row['idUE']; ?>">
                          <label class="custom-control-label" for="<?php echo $row['nomUE']; ?>"><b><?php echo $row['nomUE']; ?></b></label>
                        </div>

                        <span class="statut-text text-white" id="<?php echo $row['idUE']; ?>"><?php echo $row['statut']; ?></span>
            ...
            $('.checkbox').click(function()
              {
                ...
                if(type_abonne == 'Petite Entreprise')
                {
                  ...
                  {
                    err3("Vous devez juste cocher une seule Unité d'exploitation.");
                  }
                }
                else
                {
                  ...
                  {
                    err3("Vous devez juste cocher 5 Unités d'exploitation.");
                  }
                }
                //alert(check);
