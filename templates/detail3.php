        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="section-header">
                    ...
                    <h4>Spécialiste en programmation et système d'information</h4>
                    <p>Développeur des applications Web, Android et Windows. Développeur et Concepteur des interfaces KEDIS Online. Développement d'espaces membres et Forum. Développement des applications administratives et de bureau. Maîtrise des logiciels de traitement et conception d'images.</p>
                    <p>
                        Domaines des compétences :
                    </p>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Définition du cahier des charge.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Création des sites webs.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Création des applications Android.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Création des applications Windows.</p>
                    </div>
                     <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Design et traitement d'images.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Langages web : HTML, CSS, JS, PHP, PYTHON.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
                        <p>Langages Desktop et Android : Java.</p>
                    </div>
                    <div class="feature">
                        <i class="fa fa-check"></i>
