              ...
              <div class="animated fadeIn">
                <div class="card">
                  ...
                  <?php 
                    ...
                    $view = $bdd->prepare("SELECT * FROM depense_for_user WHERE id_UE_dp = ? AND reste_a_payer_dp != 0 AND complete_dp != ?");
                  ...
                  ?>
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des factures d'achat à payer (Total : <?php echo $existallvente; ?>)</b></strong></div>
                                <div class="card-body">
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                            ...
                                            $get_fact = $bdd->prepare('SELECT * FROM depense_for_user WHERE id_UE_dp = ? AND reste_a_payer_dp != 0 ORDER BY id_dp DESC');
                                         ...
                                         ?>   
                                            <tr>
                                                <td class="text-left"><?php echo $row['num_dp']; ?></td>
                                                ...
                                                <td class="text-left">
                                                  <?php
                                                      ...
                                                      $get_debiteur->execute(array($row['id_four_dp']));
                                                ...
                                                <td class="text-left">
                                                  <?php
                                                      ...
                                                      $get_gestionnaire->execute(array($row['id_gest_dp']));
                                                ...
                                                <td>
                                                  <a class="text-primary viewFacture" role="button" href="#" id="<?php echo $row['id_dp']; ?>" option="<?php echo $row['reste_a_payer_dp']; ?>" data-toggle="modal" data-target="#detail-facture">Consulter</a>
                                                </td>
                                              </tr>
                                          <?php 
                                            } 
                                    ?>
                                      ...
                                      <?php
                                        $sum_fact = $bdd->prepare("SELECT SUM(reste_a_payer_dp) AS montant_reste FROM depense_for_user WHERE id_UE_dp = ? AND reste_a_payer_dp != 0 ");
          ...
          jQuery(document).ready(function($) 
          {
            ...
            function affiche_facture_apayer()
            {
              ...
              $.ajax(
                {
                  type  : 'POST',
                  url   : 'fonction/affiche_facture_apayer_fournisseur.php',
            ...
            $('.viewFacture').click(function()
            {
              ...
              {
                type  : 'POST',
                url   : 'fonction/affiche_detail_dette_four.php',
                data  : 'id_dp=' + id_dp + '&devise=' + devise + '&idUE=' + idUE + '&id_cmp=' + id_cmp,
                success:function(data)
                {
                  $('#idachat').text(id_dp);
