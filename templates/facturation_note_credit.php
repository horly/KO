      ...
      /*rendre le tableau le curseur des pointer*/
       ...
       .scrollfact
        ...
        .viewtva_ser
        {
         ...
         <title>KEDIS Online! | Mes recettes | facturation note crédit</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idClient']) AND isset($_GET['refcaise']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $getCodeCredit = $bdd->prepare("SELECT * FROM note_credit WHERE reference_cr = ? AND id_UE_cr = ? ");
                          $getCodeCredit->execute(array($refcaise, $idUE));

                          $fetchIdCredit = $getCodeCredit->fetch();

                          $idcredit = $fetchIdCredit['id_cr']; //on recupère l'id
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="noteCredit.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>">Mes notes de crédit</a></li>
                                        <li class="active">Créer une nouvelle note de crédit</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
              ...
              <div class="animated fadeIn">
                ...
                <div class="card">
                  <div class="card-header">
                    <h6>Créer une nouvelle note de crédit</h6>
                  </div>
                  <div class="card-body">
       ...
       <?php  include('chat_discution.php'); ?>
        ...
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            function affiche_designation()
              {
                ...
                $.post('fonction/recup_facture_note_credit.php', {idcredit:idcredit}, function(data)
                {
                  $('#tbody_fac').html(data);
                });
              }
            ...
            $('.insert-facture').click(function()
              {
                ...
                var idcredit = '<?php echo $idcredit; ?>';
                    ...
                    $.ajax({
                    type : 'POST',
                    url : 'fonction/select_article_note_credit.php',
                    data : "id_article=" + id_article + "&idUE=" + idUE + "&idcredit=" + idcredit,
            ...
            $('.insert-facture1').click(function()
              {
                ...
                var idcredit = '<?php echo $idcredit; ?>';
                    ...
                    $.ajax({
                    type : 'POST',
                    url : 'fonction/select_service_note_credit.php',
                    data : "id_service=" + id_service + "&idUE=" + idUE + "&idcredit=" + idcredit,
                    success:function(data)
                    {
                      //alert(data);
            ...
            {
              var idcredit = '<?php echo $idcredit; ?>';
              $.post('fonction/calcul_total_ttc_note_credit.php', {idcredit:idcredit}, function(data)
              {
                $('#total_ttc').val(data);
                $('#Apayer').val(data);
            ...
            $('#add_qt').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                  $.ajax({
                    type: "POST",
                    url: "fonction/add_quantite_note_credit.php",
                    data: "code_designation=" + code_designation + "&designation=" + designation + "&idcredit=" + idcredit + 
            ...
            $('#remove_qt').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                  $.ajax({
                    type: "POST",
                    url: "fonction/remove_quantite_note_credit.php",
                    data: "code_designation=" + code_designation + "&designation=" + designation + "&idcredit=" + idcredit + 
                          '&type_element=' + type_element,
                    success:function(data)
                    {
            ...
            $('#delete_art').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                  $.ajax({
                    type: "POST",
                    url: "fonction/delete_element_note_credit.php",
                    data: "code_designation=" + code_designation + "&designation=" + designation + "&idcredit=" + idcredit + 
                          "&type_element=" + type_element,
                    success:function(data)
                    {
              ...
              $('#payer').click(function()
                {
                  ...
                  if(idClient != '')
                  {
                    $.ajax({
                      type : 'POST',
                      url : 'fonction/save_note_credit.php',
                      data : "idcredit=" + idcredit + "&date=" + date + 
                              "&date_echeance=" + date_echeance + '&idUE=' + idUE + '&getid=' + getid + '&idClient=' + idClient,
                      success:function(data)
                      {
                        //alert(data);
                        if(data != 1)
                        ...
                        {
                          window.location.href = 'noteCredit_finish.php?id=' + getid + '&id_connexion=' + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE + "&idcredit=" + idcredit;
                        }
                      }
                    });
                  }
