    ...
    <style type="text/css">
      ...
      .viewtva_ser
      {
       ...
       #libsearchcatart5, #libsearchcatart6 {
         ...
         <title>KEDIS Online! | Mes tables</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="#">Mes tables</a></li>
                                        <li class="active">Mes tables</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                  <h6 class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="#"><strong>Mes tables</strong></a>
                        </li>
                      ...
                      <?php 
                          ...
                          $view = $bdd->prepare("SELECT * FROM tables WHERE idUE_table = ?");
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des tables (Total : <?php echo $existallvente; ?>).</b></strong></div>
                                <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                              ...
                                              <div class="alert alert-primary" role="alert">
                                                Vous avez atteint le nombre maximal des tables.
                                              </div>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <?php 
                                                  ...
                                                  $get_serv->execute(array($row['id_serveur']));
                                                  $info_serv = $get_serv->fetch();

                                                  echo $info_serv['prenom_serv'];

                                                ?>    
                                              </td>
                                              <td class="text-center">
                                                <a class="text-primary" href="viewTable.php?id=<?php echo $getid;?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE;?>&nom_entreprise=<?php echo $nomE;?>&nom_unite_exploitation=<?php echo $nomUE;?>&id_table=<?php echo $row['id'];?>">Détails</a>
                                              </td>
                                          </tr>
                                          <?php 
                                            } 
