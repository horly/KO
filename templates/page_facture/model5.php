	...
	<div class="row">
		<div class="col-md-6">
			<?php
			    ...
			    {
			  ?>
				   <h3><strong>FACTURE N° <?php echo $fetchvente['num_facture']; ?></strong></h3>
			  <?php
			    }
			    else
			    {
			  ?>
			    <h3><strong><?php echo strtoupper($fetchUE['titre_document_facture']); ?> N° <?php echo $fetchvente['num_facture']; ?></strong></h3>
			  <?php
			    }
			  ?>
