	...
	<div class="row">
		<div class="col-md-6">
			<?php
			    ...
			    {
			?>
				   <h1 class="text-left text-royal-blue"><strong>NOTE DE CREDIT</strong></h1>
			<?php
			    }
			    else
			    {
			?>
			    <h1 class="text-left text-royal-blue"><strong><?php echo strtoupper($fetchUE['titre_document_note_credit']); ?></strong></h1>
			<?php
			    }
			?>
		</div>
