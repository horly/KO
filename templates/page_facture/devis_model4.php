	...
	<div class="row">
		...
		<div class="col-md-4">
			<?php
			    ...
			    {
			  ?>
				   <h3 class="text-success"><strong>OFFRE DE SERVICE N° <?php echo $fetchvente['num_dv']; ?></strong></h3>
			  <?php
			    }
			    else
			    {
			  ?>
			    <h3 class="text-success"><strong><?php echo strtoupper($fetchUE['titre_document_devis']); ?> N° <?php echo $fetchvente['num_dv']; ?></strong></h3>
			  <?php
			    }
			  ?>
