	...
	<div class="row">
		<div class="col-md-6">
			<?php
			    ...
			    {
			  ?>
				   <h3><strong>OFFRE DE SERVICE N° <?php echo $fetchvente['num_dv']; ?></strong></h3>
			  <?php
			    }
			    else
			    {
			  ?>
			    <h3><strong><?php echo strtoupper($fetchUE['titre_document_devis']); ?> N° <?php echo $fetchvente['num_dv']; ?></strong></h3>
			  <?php
			    }
			  ?>
			  <h5><b>Date : <?php echo $fetchvente['date_dv']; ?></b></h5>
			  <h5><b>Date échéance : <?php echo $fetchvente['echeance_dv']; ?></b></h5>
		</div>
		<div class="col-md-6">
