	...
	<div class="row">
		<div class="col-md-6">
			<?php
			    ...
			    {
			  ?>
				   <h3><strong>NOTE DE CREDIT <?php echo $fetchcredit['num_credit']; ?></strong></h3>
			  <?php
			    }
			    else
			    {
			  ?>
			    <h3><strong><?php echo strtoupper($fetchUE['titre_document_note_credit']); ?> N° <?php echo $fetchcredit['num_credit']; ?></strong></h3>
			  <?php
			    }
			  ?>
			  <h5><b>Date : <?php echo $fetchcredit['date_cr']; ?></b></h5>
			  <h5><b>Date échéance : <?php echo $fetchcredit['echeance_cr']; ?></b></h5>
		</div>
		<div class="col-md-6">
			<div class="p-3 mb-2 bg-yellow-pal">
	       ...
	       ?>   
	          <tr>
	            ...
	            ?>
	              ...
	              <td class="text-right"><?php echo number_format($rows['prix_hors_tva_cr'] * -1, 2, '.', ' '); ?></td>
	        ...
	        <tfoot class="border border-warning bg-warning text-white">
	          <tr>
	              <?php
	...
	<?php 
  	...
  	<div class="row">
	 	<div class="col-md-6">
	      	<table class="table border border-warning">
		      	<thead>
		      		<tr class="bg-warning boder border-warning text-white">
	          ...
	          <tfoot>
	            <tr class="bg-warning border border-warning text-white">
