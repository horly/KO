	...
	<div class="row">
		...
		<div class="col-md-4">
			<?php
			    ...
			    {
			  ?>
				   <h3 class="text-success"><strong>NOTE DE CREDIT N° <?php echo $fetchcredit['num_credit']; ?></strong></h3>
			  <?php
			    }
			    else
			    {
			  ?>
			    <h3 class="text-success"><strong><?php echo strtoupper($fetchUE['titre_document_note_credit']); ?> N° <?php echo $fetchcredit['num_credit']; ?></strong></h3>
			  <?php
			    }
			  ?>
