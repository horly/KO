...
<!--Début html-->
    ...
    <style type="text/css">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Vous avez choissi le type d'abonnement "MOYENNE ENTREPRISE". </h6>
                    </div>
                    <div class="alert alert-success" role="alert">
       ...
       <!--Paypal id live online-->
        <script src="https://www.paypal.com/sdk/js?client-id=AakrUgz2pdPR5NPOiTjeVqaeqfas_l9DkKQbtUst6SigZmraHqTUsz-QTJjrbF7RF3TjMCsJPbNfZBq7">
        </script>

        <!--Paypal id sand box local-->
        <!--<script src="https://www.paypal.com/sdk/js?client-id=AXIfI2VjcZsydyG0KOyZVBHcLtPmxm_CVIITCd5rC6BYM5uUTNOWs8KVlbvaaLR3mGgfN7bP3de8LWp8">
        </script>-->
                        ...
                        onApprove: function(data, actions) {
                          ...
                          return actions.order.capture().then(function(details) {
                            ...
                            $.ajax(
                                {
                                    type    : 'POST', 
                                    url     : 'fonction1/paiement_moyenne_entreprise.php',
                                    data    : 'email=' + email,
