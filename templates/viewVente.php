    ...
    <style type="text/css">
      ...
      .btn-orange:hover
      {
        background-color: #D2691E;
         ...
         <title>KEDIS Online! | Mes vente | Détails vente</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idvente']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $reqvente = $bdd->prepare("SELECT * FROM vente_for_user WHERE id_fact = ?"); 
                          $reqvente->execute(array($idvente));

                          $infosVente = $reqvente->fetch();

                          $refCaise = $infosVente['reference_caise'];
                          $idClient = $infosVente['id_cl_fact'];
    ...
    <div id="body">              
       <!--on inlus la navigation du menu -->
        <?php include('navigation.php'); ?>
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Détails vente</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
              ...
              <div class="animated fadeIn">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-2">
                        <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#apercu-vente">
                      ...
                      <div class="col-md-2">
                        <a role="button" class="btn btn-orange btn-block text-white" href="facturation_finish.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&idvente=<?php echo $idvente; ?>">
                          <span class="step size-21">
                      ...
                      <?php
                          ...
                          if($infosVente['reste_a_payer_fact'] != 0)
                          {

                      ?>

                      <div class="col-md-2">
                        <button role="button" class="btn btn-success btn-block" id="solder" data-toggle="modal" data-target="#solder-vente">
                          <span class="step size-21">
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-block" id="delete-vente">
                          <span class="step size-21">
         ...
         <!--debut aperçu achat-->
            <div class="modal fade bd-example-modal-lg" tabindex="-1" id="apercu-vente" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <!-- Modal détail facture à payer -->
              <div class="modal fade" tabindex="-1" id="solder-vente" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header badge-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLabel">Solder facture de vente <label class="text-secondary" id="dette_initial"><?php echo number_format($infosVente['reste_a_payer_fact'], 2, '.', ''); ?></label></h6>
                        </div>
                        <div class="col-md-2">
                           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                      <button type="button" class="btn btn-primary" id="solder_vente">Solder</button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header badge-secondary text-white">
                        <div class="row">
                          <div class="col-md-10">
                            <h6 class="modal-title" id="exampleModalLabel">Echéance vente <label class="text-secondary" id="id_echeance">0</label></h6>
                          </div>
                          <div class="col-md-2">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
        ...
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              affiche_apercu_vente();

              function affiche_apercu_vente()
              {
                var idvente = '<?php echo $idvente; ?>';
                var devise = '<?php echo $devise; ?>';
                  ...
                  swal({
                          ...
                          function(){
                              ...
                              swal(
                                ...
                                type: "success",
                                confirmButtonColor: "#28a745",
                                }, function(){ window.location = 'vente.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE; });
                          });
                });
              ...
              function affiche_transaction_vente()
              {
                ...
                $.ajax(
                  {
                    type  : 'POST', 
                    url   : 'fonction/affiche_transaction_facture_vente.php',
                    data  : 'idvente=' + idvente + '&idUE=' + idUE + '&devise=' + devise,
                    success:function(data)
                    {
             ...
             $('#change_echeance').click(function()
              {
                ...
                {
                  type  : 'POST',
                  url   : 'fonction/new_echeance_vente.php',
                  data  : 'idvente=' + idvente + '&date_echeance=' + date_echeance,
                  success:function(data)
                  {
                                        ...
                                        if(donnee == 1)
                                        {
                                          ...
                                          else
                                          {
                                            $.ajax(
                                              {
                                                type  : 'POST', 
                                                url   : 'fonction/solder_facture_vente.php',
                                                data  : 'idvente=' + idvente + '&montant=' + montant +
