    ...
    <style type="text/css">
      ...
      .btn-orange:hover
      {
        background-color: #D2691E;
         ...
         <title>KEDIS Online! | Mes dépenses | Détails achat</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
    <!--Début body-->
        ...
        <!--Code PHP-->
                <?php 
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idachat']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $reqdepense = $bdd->prepare("SELECT * FROM depense_for_user WHERE id_dp = ?"); 
                          $reqdepense->execute(array($idachat));

                          $infosdepense = $reqdepense->fetch();

                          $refCaise = $infosdepense['reference_dp'];
                          $idFour = $infosdepense['id_four_dp'];
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="depense.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>">Mes achats</a></li>
                                        <li class="active">Détails achat</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <?php
                          ...
                          if($infosdepense['reste_a_payer_dp'] != 0)
                          {
                      ...
                      ?>
                      <!--<div class="col-md-2">
                        <a role="button" class="btn btn-primary btn-block" id="update" href="achat_update.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&refcaise=<?php echo $refCaise; ?>&idFour=<?php echo $idFour; ?>">
                          <span class="step size-21">
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header badge-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLabel">Solder achat <label class="text-secondary" id="dette_initial"><?php echo number_format($infosdepense['reste_a_payer_dp'], 2, '.', ''); ?></label></h6>
                        </div>
                        <div class="col-md-2">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                      <button type="button" class="btn btn-primary" id="solder_achat">Solder</button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header badge-secondary text-white">
                        <div class="row">
                          <div class="col-md-10">
                            <h6 class="modal-title" id="exampleModalLabel">Echéance achat <label class="text-secondary" id="id_echeance">0</label></h6>
                          </div>
                          <div class="col-md-2">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              function affiche_detail()
              {
                ...
                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/detail_achat.php',
                  data : 'idachat=' + idachat + '&devise=' + devise,
             ...
             affiche_apercu_achat();

              function affiche_apercu_achat()
              {
                var idachat = '<?php echo $idachat; ?>';
                var devise = '<?php echo $devise; ?>';
              ...
              $('#delete_achat').click(function()
                {
                  ...
                  swal({
                          title: "Confirmer !",
                          text: "Voulez-vous vraiment supprimer cet achat ?",
                          type: "warning",
                          ...
                          function(){
                              ...
                              swal(
                                ...
                                type: "success",
                                confirmButtonColor: "#28a745",
                                }, function(){ window.location = 'depense.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE; });
                          });
                });
             ...
             affiche_transaction_vente(); 
              function affiche_transaction_vente()
              {
                ...
                $.ajax(
                  {
                    type  : 'POST', 
                    url   : 'fonction/affiche_transaction_facture_achat.php',
                    data  : 'idachat=' + idachat + '&idUE=' + idUE + '&devise=' + devise,
                    success:function(data)
                    {
             ...
             $('#change_echeance').click(function()
              {
                ...
                {
                  type  : 'POST',
                  url   : 'fonction/new_echeance_achat.php',
                  data  : 'id_dp=' + idachat + '&date_echeance=' + date_echeance,
                  success:function(data)
                  {
                                                  ...
                                                  if(donnee == 1)
                                                  {
                                                    ...
                                                    else
                                                    {
                                                      $.ajax(
                                                        {
                                                          type  : 'POST', 
                                                          url   : 'fonction/solder_facture_achat.php',
                                                          data  : 'idachat=' + idachat + '&montant=' + montant +
                                                          ...
                                                          success:function(data)
                                                          {
                                                            ...
                                                            $('#num_cmp').val('');
                                                            valid3('Achat soldée avec succès');
