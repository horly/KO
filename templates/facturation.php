                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Créer une nouvelle Vente/Facture</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
              ...
              <div class="animated fadeIn">
                ...
                <div class="card">
                  <div class="card-header">
                    <h6>Créer une nouvelle Vente/Facture</h6>
                  </div>
                  <div class="card-body">
                            ...
                            <div class="col-md-7">
                              ...
                              <div class="card bg-secondary text-white">
                                 <div class="card-body">
                                  ...
                                  <div class="col-md-6">
                                    <label><h6>&nbsp;</h6></label>
                                    <button type="button" class="btn btn-success btn-block" id="paiement">Enregistrer</button>
                                  </div>
                                  </div>
                                  </div>
                              </div>
                              ...
                              <div class="card">
                                <h6 class="card-header">
                                  <ul class="nav nav-pills card-header-pills">
                                    <li class="nav-item">
                                      <a class="nav-link active" id="pills-home2-tab" data-toggle="pill" href="#home2" role="tab"><h6>Mes articles</h6></a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" id="pills-home3-tab" data-toggle="pill" href="#home3" role="tab"><h6>Mes services</h6></a>
                                    </li>
                                  </ul>
                                </h6>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-success" name='payer' id="payer">Valider</button>
                        </div>
                    </div>
                  </div>
                  </div>
            ...
            $('.insert-facture').click(function()
              {
                ...
                var idvente = '<?php echo $idvente; ?>';
                    ...
                    $.ajax({
                    type : 'POST',
                    url : 'fonction/select_article_facture_vente.php',
                    data : "id_article=" + id_article + "&idUE=" + idUE + "&idvente=" + idvente,
            ...
            $('.insert-facture1').click(function()
              {
                ...
                var idvente = '<?php echo $idvente; ?>';
                    ...
                    data : "id_service=" + id_service + "&idUE=" + idUE + "&idvente=" + idvente,
                    success:function(data)
                    {
                      //alert(data);
                        calcul_tota_ttc();
                                              ...
                                              if(dev != 1)
                                              {
                                                $.ajax(
                                                {
                                                  ...
                                                  data : "idvente=" + idvente + "&date=" + date + 
                                                          ...
                                                          + "&id_cmp=" + id_cmp + '&getid=' + getid + '&num_cmp_cli=' + num_cmp_cli + '&Apayer=' + Apayer + '&id_client=' + id_client,
