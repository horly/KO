...
<!--Début html-->
    ...
    <style type="text/css">
        ...
        <div class="container">
            <br><br><br><br><br>
            <h3>
                Félicitations <strong><?php echo $prenom; ?></strong></h3>
            <hr>
            <div class="row">
                <div class="col-md-7">
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Vous voilà à la dernière étape pour la confirmation de votre compte! </h6>
                    </div>
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Veuillez créer un mot de passe pour vous permettre de vous connecter à la plateforme.</h6>
                    </div>
                    <div class="alert alert-info" role="alert"><h6 class="text-center">Nous vous en remercions. <img id="god" src="../img/good.png"></h6></div>
                </div>
                <div class="col-md-5">
                    <div class="card">
                        <h6 class="card-header text-center">Création mot de passe</h6>
                        <div class="card-body">
