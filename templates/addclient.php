      ...
      .card
      {
        ...
        <!--Code PHP-->
                <?php 
                    ...
                    if(isset($_GET['id']) AND $_GET['id_connexion'] AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                            ...
                            if(preg_match("/^[a-zA-Z]+/", $nomcli))
                            {
                              if(preg_match("/^[0-9]+/", $telcli))
                              {
                                if(preg_match("/^[0-9]+/", $postalecli))
                                {
                                    ...
                                    header("location:contacts.php?id=".$getid."&idEU=".$idUE."&nom_entreprise=".$nomE."&nom_unite_exploitation=".$nomUE);
                                }
                                else 
                                {
                                  $erpostalcli = "";
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Mes contacts</h1>
             <div class="btn-toolbar mb-2 mb-md-0">
                <a class="btn btn-sm btn-outline-info" href="contacts.php?id=<?php echo $getid; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>" role="button" title="RETOUR A LA PAGE PRECEDENTE">
            ...
            <form method="post" action="">
                <div class="card border-secondary mb-3">
                  <div class="card-header text-white bg-secondary"><h6><strong>Ajouter un client</strong></h6></div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
