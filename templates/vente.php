                ...
                <div class="card">
                  <h6 class="card-header">
                     <ul class="nav nav-pills card-header-pills">
                      ...
                      ?>
                        <li class="nav-item">
                          <a class="nav-link active" href="#"><strong>Mes ventes</strong></a>
                        </li>
                      <?php
                          }
                      ?>
                      ...
                      <div class="card-body">
                          <div class="card border-info mb-3" >
                              <div class="card-header text-left"><strong><b>Liste des ventes (Total : <?php echo $existallvente; ?>)</b></strong></div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                      <div class="col-md-2">
                                        ...
                                        ?>
                                            ...
                                            <a role="button" class="btn btn-success btn-block" href="vente_init.php?id=<?php echo $getid;?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE;?>&nom_entreprise=<?php echo $nomE;?>&nom_unite_exploitation=<?php echo $nomUE;?>" >
                                              <span class="step size-21">
                                                  <i class="icon ion-document-text"></i>
                                              </span>
                                                  &nbsp;Etablir une facture</a>
                                  ...
                                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-bordered" id="table_article">
                                      <?php
                                       ...
                                       $view = $bdd->prepare("SELECT * FROM vente_for_user WHERE id_UE_fact = ? AND complete_vente != ? ORDER BY reference_caise DESC");
                                        $view->execute(array($idUE, 0));
                                        ...
                                        $existallvente = $view->rowCount();
                                         ...
                                         ?>   
                                            <tr>
                                              <td><a class="text-primary" href="viewVente.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&idvente=<?php echo $row['id_fact']; ?>"><?php echo $row['num_facture']; ?></a></td>
                                              ...
                                              <td>
                                                <a class="text-primary" href="viewVente.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&idvente=<?php echo $row['id_fact']; ?>">Détails</a>
                                              </td>
                                            </tr>
                                          <?php 
                                            } 
                                    ...
                                    <?php
                                        ...
                                        //somme total à payer
                                        $somme_mt_fact = $bdd->prepare("SELECT SUM(montant_facture) AS somme_ttc FROM vente_for_user WHERE id_UE_fact = ? AND complete_vente = 1");
                                        $somme_mt_fact->execute(array($idUE));
                                        $fetch_ttc = $somme_mt_fact->fetch();
                                        $total_ttc = number_format($fetch_ttc['somme_ttc'], 2, '.', '');

                                        //somme montant payé
                                        $somme_paie = $bdd->prepare("SELECT SUM(paiemant_recu_fact) AS somme_paie FROM vente_for_user WHERE id_UE_fact = ? AND complete_vente = 1");
                                        $somme_paie->execute(array($idUE));
                                        $fetch_paie = $somme_paie->fetch();
                                        $total_paie = number_format($fetch_paie['somme_paie'], 2, '.', '');

                                        //somme reste à payer
                                        $somme_reste = $bdd->prepare("SELECT SUM(reste_a_payer_fact) AS somme_reste FROM vente_for_user WHERE id_UE_fact = ? AND complete_vente = 1");
             ...
             //affiche_vente();
              ...
              function affiche_vente()
              {
                ...
                var id_connexion = '<?php echo $id_connexion; ?>';
                 ...
                 $.ajax({
                  type : 'POST', 
                  url  : 'fonction/affiche_vente.php',
