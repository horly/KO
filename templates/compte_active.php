...
<!--Début html-->
    ...
    <style type="text/css">
        ...
        <div class="container">
            <br><br><br><br><br>
            <h3>
                Félicitations <?php echo $sexe ?> <strong><?php echo $prenom; ?></strong></h3>
            <hr>
            <div class="row">
                <div class="col-md-7">
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Vous avez activé votre compte </h6>
                    </div>
                    <div class="alert alert-success" role="alert">
                        <h6 class="text-center">Veuillez vous connecter pour accéder à votre compte</h6>
                        <h6 class="text-center">Profitez bien de vos 30 jours d'essaie gratuit de la plateforme</h6>
                    </div>
                    <!--<div class="alert alert-success" role="alert">
