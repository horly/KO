                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idFour']) AND isset($_GET['refcaise']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $getCodeAchat = $bdd->prepare("SELECT * FROM commande WHERE reference_cmd = ? AND id_UE_cmd = ? ");
                          $getCodeAchat->execute(array($refcaise, $idUE));

                          $fetchIdAchat = $getCodeAchat->fetch();

                          $id_cmd = $fetchIdAchat['id_cmd']; //on recupère l'id
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Créer une nouvelle commande</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php
                      ...
                      <!--Début row 1-->
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <label for="date_echeance"><h6>Délai de livraison</h6></label>
                            <div class="input-group mb-3">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-default"><img width="18" height="18" class="icone" src="../png/512/calendar.png"></span>
                                </div>
        ...
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) 
          {
            ...
            function affiche_designation()
            {
              ...
              $.post('fonction/recup_commande.php', {id_cmd:id_cmd}, function(data)
              {
                $('#tbody_fac').html(data);
              });
            }
           ...
           $('.insert-facture').click(function()
              {
               ...
               $.ajax(
                {
                  type : 'POST',
                        url : 'fonction/select_article_facture_commande.php',
                        data : "id_article=" + id_article + '&id_cmd=' + id_cmd,
            ...
            $('.insert-facture1').click(function()
              {
                ...
                {
                  type : 'POST',
                    url : 'fonction/select_service_facture_commande.php',
                    data : "id_service=" + id_service + "&id_cmd=" + id_cmd,
                    success:function(data)
                      {  /*si data = 0, on affiche le modal, sinon on ne fait rien et on affiche parce que la quantité a 
                        augmenté*/
                        //alert(data)
            ...
            $('#add_qt').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                    $.ajax({
                      type: "POST",
                      url: "fonction/add_quantite_commande.php",
                      data: "code_designation=" + code_designation + "&designation=" + designation + "&id_cmd=" + id_cmd + 
            ...
            $('#remove_qt').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                  $.ajax({
                    type: "POST",
                    url: "fonction/remove_quantite_commande.php",
                    data: "code_designation=" + code_designation + "&designation=" + designation + "&id_cmd=" + id_cmd + 
                          "&type_element=" + type_element,
                    success:function(data)
                    {
            ...
            $('#delete_art').click(function()
              {
                ...
                if(code_designation != '' && designation != '')
                {
                  $.ajax({
                    type: "POST",
                    url: "fonction/delete_element_facture_commande.php",
                    data: "code_designation=" + code_designation + "&designation=" + designation + "&id_cmd=" + id_cmd + 
                          "&type_element=" + type_element,
                    success:function(data)
                    {
              ...
              $('#payer').click(function()
                {
                  ...
                  if(idFour != '')
                  {
                    ...
                    $.ajax({
                      type : 'POST',
                      url : 'fonction/save_commande.php',
                      data : "id_cmd=" + id_cmd + "&date=" + date + 
                      ...
                      success:function(data)
                      {
                        ...
                        {
                          window.location.href = 'commande_finish.php?id=' + getid + '&id_connexion=' + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE + "&id_cmd=" + id_cmd;
                        }
                      }
                    });
                  }
