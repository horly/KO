     ...
     .form_card
      ...
      #logoUE
      {
        height: 100px;
         ...
         <title>KEDIS Online! | Note de crédit | facturation</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idcredit']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          $getid_cli = $bdd->prepare("SELECT * FROM note_credit WHERE id_cr = ?");
                          $getid_cli->execute(array($idcredit));
                          $fetch_id_cl = $getid_cli->fetch();
                          $id_cli = $fetch_id_cl['id_cl_cr'];
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-primary btn-block" id="send-facture-mail" title="Envoyer la note de crédit au client par émail">
                          <span class="step size-21">
                      ...
                      <div class="col-md-2">
                        <a role="button" class="btn btn-success btn-block" href="viewNoteCredit.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&idcredit=<?php echo $idcredit; ?>">
                          <span class="step size-21">
                              ...
                              <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Modifier le nom du document" aria-label="Recipient's username" aria-describedby="basic-addon2" name="name-doc" id="name-doc" value="<?php
                                    if($infoart['titre_document_note_credit'] == '')
                                      {
                                        echo ucwords('note de crédit');
                                      }
                                      else
                                      {
                                          echo ucwords($infoart['titre_document_note_credit']);
                                      }
                                  ?>">
                                </div>
                                <label>Note de bas du document</label>
                                <textarea class="form-control" rows="3" id="note-bas-page" placeholder="Modifier la note de bas de page"><?php echo $fetch_facture_modele['note_bas_cr']; ?></textarea>
                              </div>
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              function affiche_detail()
              {
                ...
                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/detail_noteCredit.php',
                  data : 'idcredit=' + idcredit + '&devise=' + devise + '&idUE=' + idUE +
                          '&nomE=' + nomE,
              ...
              $('#print_facture').click(function()
                {
                  ...
                  window.open('page_facture/facture_note_de_credit_pdf.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE + '&idcredit=' + idcredit + '&devise=' + devise, '_blank');
                  //window.open('facture/pdf/facture_default_note_credit.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE + '&idcredit=' + idcredit + '&devise=' + devise, '_blank');
               ...
               $('#save-name-doc').click(function()
                {
                  ...
                  $.ajax(
                    {
                      type  : 'POST',
                      url   : 'fonction/sava_info_doc_cr.php',
             ...
             $('#send-facture-mail').click(function()
              {
                  ...
                  $.ajax(
                    {
                      type  : 'POST', 
                      url   : 'fonction/send_facture_mail_noteCredit.php',
                      data  : 'idcredit=' + idcredit + '&devise=' + devise + '&getid=' + getid +
