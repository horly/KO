    ...
    <style type="text/css">
      ...
      .btn-orange:hover
      {
        background-color: #D2691E;
         ...
         <title>KEDIS Online! | Mes vente | Détails note crédit</title>
    <!--c head-->
    </head>
    <!--*****************************************************-->
    <body class="bg-light">
    <!--Début body-->
        ...
        <!--Code PHP-->
                <?php 
                    ...
                    if(isset($_GET['id']) AND isset($_GET['id_connexion']) AND isset($_GET['idEU']) AND isset($_GET['nom_entreprise']) AND isset($_GET['nom_unite_exploitation']) AND isset($_GET['idcredit']))  //si la variable id qu'on a transité existe dans l'url 
                    {
                      ...
                      if($id_connexion == $get_id_connexion)
                      {
                        ...
                        if($login_required == 1)
                        {
                          ...
                          /*on recupère aussi l'id de la note de credit à partir de la 
                          ...
                          $reqvente = $bdd->prepare("SELECT * FROM note_credit WHERE id_cr = ?"); 
                          $reqvente->execute(array($idcredit));

                          $infosVente = $reqvente->fetch();

                          $refCaise = $infosVente['reference_cr'];
                          $idClient = $infosVente['id_cl_cr'];
       ...
       <!--on inlus la navigation du menu -->
        <?php include('navigation.php'); ?>
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="noteCredit.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>">Mes notes de crédits</a></li>
                                        <li class="active">Détails note de crédit</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
              ...
              <div class="animated fadeIn">
                <div class="card">
                  <div class="card-header text-white bg-secondary">
                    <h6>Détails note de crédit</h6>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-2">
                        <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#apercu-credit">
                      ...
                      <div class="col-md-2">
                        <a role="button" class="btn btn-orange btn-block text-white" href="noteCredit_finish.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&idcredit=<?php echo $idcredit; ?>">
                          <span class="step size-21">
                      ...
                      <?php
                          ...
                          if($infosVente['reste_a_payer_cr'] != 0)
                          {

                      ?>

                      <div class="col-md-2">
                        <button role="button" class="btn btn-success btn-block" id="solder" data-toggle="modal" data-target="#solder-note">
                          <span class="step size-21">
                      ...
                      <!--<div class="col-md-2">
                        <a role="button" class="btn btn-primary btn-block" id="update" href="facturation_update.php?id=<?php echo $getid; ?>&id_connexion=<?php echo $id_connexion; ?>&idEU=<?php echo $idUE; ?>&nom_entreprise=<?php echo $nomE; ?>&nom_unite_exploitation=<?php echo $nomUE; ?>&refcaise=<?php echo $refCaise; ?>&idClient=<?php echo $idClient; ?>">
                          <span class="step size-21">
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-block" id="delete-note">
                          <span class="step size-21">
         ...
         <!--debut aperçu achat-->
          ...
          <!--debut aperçu achat-->
            <div class="modal fade bd-example-modal-lg" tabindex="-1" id="apercu-credit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header bg-secondary text-white">
                    <div class="row">
                      <div class="col-md-10">
                        <h6 class="modal-title" id="exampleModalLabel">Aperçu note de crédit</h6>
                      </div>
                      <div class="col-md-2">
                  ...
                  <div class="modal-body bg-light" id="apercu_credit">
            ...
            <!--fin aperçu achat-->
            <!--debut aperçu achat-->
            <div class="modal fade" id="solder-note" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header badge-secondary text-white">
                      <div class="row">
                        <div class="col-md-10">
                          <h6 class="modal-title" id="exampleModalLabel">Solder note de crédit vente <label class="text-secondary" id="dette_initial"><?php echo number_format($infosVente['reste_a_payer_cr'], 2, '.', ''); ?></label></h6>
                        </div>
                        <div class="col-md-2">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header badge-secondary text-white">
                        <div class="row">
                          <div class="col-md-10">
                            <h6 class="modal-title" id="exampleModalLabel">Echéance note de crédit <label class="text-secondary" id="id_echeance">0</label></h6>
                          </div>
                          <div class="col-md-2">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
          ...
          jQuery(document).ready(function($) 
          {
            ...
            affiche_detail(); 
              ...
              function affiche_detail()
              {
                ...
                var idcredit = '<?php echo $idcredit; ?>';
                var devise = '<?php echo $devise; ?>';

                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/detail_note_credit.php',
                  data : 'idcredit=' + idcredit + '&devise=' + devise,
              ...
              affiche_apercu_note_credit();

              function affiche_apercu_note_credit()
              {
                var idcredit = '<?php echo $idcredit; ?>';
                var devise = '<?php echo $devise; ?>';
                ...
                $.ajax({
                  type : 'POST', 
                  url  : 'fonction/apercu_note_credit.php',
                  data : 'idcredit=' + idcredit + '&devise=' + devise,
                  success:function(data)
                  {
                    $('#apercu_credit').html(data);
                  }
                });
              }
              ...
              $('#delete-note').click(function()
                {
                  ...
                  swal({
                          title: "Confirmer !",
                          text: "Voulez-vous vraiment supprimer cette note de crédit ?",
                          type: "warning",
                          ...
                          function(){
                              ...
                              swal(
                                {
                                  title: "Supprimé !!",
                                text: "La note de crédit a été supprimé avec succès !!",
                                type: "success",
                                confirmButtonColor: "#28a745",
                                }, function(){ window.location = 'noteCredit.php?id=' + getid + "&id_connexion=" + id_connexion + "&idEU=" + idUE + "&nom_entreprise=" + nomE + "&nom_unite_exploitation=" + nomUE; });
                          });
                });
              ...
              function delete_note()
              {
                  ...
                  {
                    type  : 'POST', 
                    url   : 'fonction/deleteNotreCredit.php',
                    data  : 'idcredit=' + idcredit, 
                    success:function()
                    {
              ...
              affiche_transaction_note(); 
              function affiche_transaction_note()
              {
                var devise = '<?php echo $devise; ?>';
                var idcredit = '<?php echo $idcredit; ?>';
                var idUE = '<?php echo $idUE; ?>';
                ...
                $.ajax(
                  {
                    type  : 'POST', 
                    url   : 'fonction/affiche_transaction_note_credit.php',
                    data  : 'idcredit=' + idcredit + '&idUE=' + idUE + '&devise=' + devise,
                    success:function(data)
                    {
             ...
             $('#change_echeance').click(function()
              {
                ...
                {
                  type  : 'POST',
                  url   : 'fonction/new_echeance_note_credit.php',
                  data  : 'id_cr=' + idcredit + '&date_echeance=' + date_echeance,
                  success:function(data)
                  {
                          ...
                          success:function(dev)
                          {
                            ...
                            if(dev != 1)
                            {
                              $.ajax(
                              {
                                ...
                                data  : 'id_cmp=' + id_cmp + '&taux_echange=' + montantPaye + '&idUE=' + idUE,
                                              ...
                                              if(donnee == 1)
                                              {
                                                ...
                                                else
                                                {
                                                  $.ajax(
                                                    {
                                                      type  : 'POST', 
                                                      url   : 'fonction/solder_facture_note_credit.php',
                                                      data  : 'id_cr=' + idcredit + '&montant=' + montant +
                                                    ...
                                                    $.ajax(
                                                      {
                                                        ...
                                                        success:function(data)
                                                        {
                                                          ...
                                                          $('#autre_devise1').removeClass('is-invalid');
                                                          $('#num_cmp').val('');
                                                          valid3('Vente soldée avec succès');
